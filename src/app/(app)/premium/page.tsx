...
export const metadata: Metadata = {
  title: "Area Premium",
  description: "Conteudos premium da PGM Academy para preparacao do aluno.",
};
      ...
      <main className="px-4 py-6 sm:px-6 lg:px-8">
        <section className="rounded-md border border-border-soft bg-surface p-5 sm:p-6">
          ...
          <h1 className="mt-4 text-3xl font-semibold text-white">
            Conteudos premium bloqueados
          </h1>
          <p className="mt-4 max-w-2xl text-sm leading-6 text-muted">
            Esta area e exclusiva para alunos com acesso premium ativo. Libere
            o plano unico para acessar os guias iniciais da jornada premium.
            A PGM Academy organiza orientacoes de preparacao, sem substituir
        ...
        <div className="grid gap-6 p-5 sm:p-6 xl:grid-cols-[1fr_360px] xl:items-end">
          <div>
            ...
            <h1 className="mt-4 max-w-3xl text-3xl font-semibold text-white sm:text-4xl">
              Guias exclusivos para transformar preparacao em prontidao
            </h1>
            <p className="mt-4 max-w-3xl text-sm leading-6 text-muted">
              Conteudo inicial produzido a partir da analise editorial dos
              editais PGM 2024 e 2026. Cada modulo separa base oficial,
              orientacao reaproveitavel e pontos que devem ser confirmados no
              edital vigente.
            </p>
          </div>
          ...
          <div className="rounded-md border border-border-soft bg-background p-4">
            ...
            <p className="mt-3 text-xs leading-5 text-muted">
              Modulos com conteudo inicial publicado. Regras oficiais seguem

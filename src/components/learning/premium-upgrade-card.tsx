...
export function PremiumUpgradeCard({
  description = "Este conteúdo pode aproximar você da sua vaga no intercâmbio. Desbloqueie o plano premium para estudar com simulados, trilhas, flashcards e feedback completo.",
  href = "/planos",
